...
class ButtonConnectionColor {
  ...
  Color colbuttonConnectionReddit;
  ButtonConnectionColor({this.colbuttonConnectionGitHub = const Color.fromARGB(255, 68, 12, 10), this.colbuttonConnectionYoutube = const Color.fromARGB(255, 68, 12, 10), this.colbuttonConnectionFacebook = const Color.fromARGB(255, 68, 12, 10), this.colbuttonConnectionDiscord = const Color.fromARGB(255, 68, 12, 10), this.colbuttonConnectionTwitter = const Color.fromARGB(255, 68, 12, 10), this.colbuttonConnectionReddit = const Color.fromARGB(255, 68, 12, 10)});
}
...
class ButtonChooseColor {
  ...
  Color colbuttonChooseReddit;
  ButtonChooseColor({this.colbuttonChooseGitHub = colorDisconnected, this.colbuttonChooseYoutube = colorDisconnected, this.colbuttonChooseFacebook = colorDisconnected, this.colbuttonChooseDiscord = colorDisconnected, this.colbuttonChooseTwitter = colorDisconnected, this.colbuttonChooseReddit = colorDisconnected});
}
